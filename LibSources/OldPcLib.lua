...
function Hanki:Window(ScrName)
	...
	if taklakinq == "TaklaKing" then
		if _Hawk == "ohhahtuhthttouttpwuttuaunbotwo" then
			...
			Main.Position = UDim2.new(0.5, -255, 0.5, -214)
			Main.Size = UDim2.new(0, 549, 0, 409)
			...
			ScriptName.BackgroundColor3 = Color3.fromRGB(39, 39, 39)
			ScriptName.BackgroundTransparency = 1
			ScriptName.BorderColor3 = Color3.fromRGB(39, 39, 39)
			...
			Tabs.BorderColor3 = Color3.fromRGB(39, 39, 39)
			Tabs.Position = UDim2.new(0, 0, 0.0782396123, 0)
			Tabs.Size = UDim2.new(0, 143, 0, 377)
			...
			TabContainer.Position = UDim2.new(0, 0, 0.0365535021, 0)
			TabContainer.Size = UDim2.new(0, 143, 0, 355)
			...
			Pages.BorderColor3 = Color3.fromRGB(30, 30, 30)
			Pages.Position = UDim2.new(0.260473579, 0, 0.0929095373, 0)
			Pages.Size = UDim2.new(0, 406, 0, 371)
			...
			function Hanki:Bildirim(noftext, desctext, Time)
				...
				NotificationHold.Size = UDim2.new(0, 549, 0, 409)
				...
				NotificationDesc.Position = UDim2.new(0.0559394211, 0, 0.218999997, 0)
			...
			function TabS:Tab(TabName)
				...
				Frame.Size = UDim2.new(0, 121, 0, 28)
				...
				TabButton.Size = UDim2.new(0, 121, 0, 28)
				...
				Page.BorderColor3 = Color3.fromRGB(30, 30, 30)
				Page.BorderSizePixel = 0
				Page.Position = UDim2.new(0.00810, 0, 0.021, 0)
				Page.Size = UDim2.new(0, 397, 0, 360)
				Page.ScrollBarThickness = 4
				Page.ScrollBarImageColor3 = Color3.new(0.388235, 0.388235, 0.388235)
				Page.Visible = false
				...
				TabButton.MouseButton1Down:Connect(
					function()
						...
						for q, we in pairs(TabContainer:GetDescendants()) do
							...
							TweenService:Create(Frame, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundTransparency = 0}):Play(
				...
				function ContainerItems:Label(yazi)
					...
					Label.Size = UDim2.new(0, 381,0, 28)
					...
					Label_2.Size = UDim2.new(0, 374,0, 28)
					Label_2.Position = UDim2.new(0.018, 0,0, 0)
				...
				function ContainerItems:Button(yazi, callback)
					...
					ButtonText.Size = UDim2.new(0, 381, 0, 28)
					...
					Button.Size = UDim2.new(0, 381, 0, 28)
					Button.BackgroundTransparency = 1
					Button.Font = Enum.Font.GothamBold
					Button.TextColor3 = Color3.fromRGB(154, 154, 154)
					Button.TextSize = 14.000
					Button.TextTransparency = 1
					Button.Text = ""

					UICorner_12.CornerRadius = UDim.new(0, 5)
					UICorner_12.Parent = ButtonText
				...
				function ContainerItems:Slider(Text, minvalue, maxvalue, callback)
					...
					local uyu = Instance.new("UICorner")
					...
					SliderFrame.Position = UDim2.new(0.0196850393, 0, 0.539682567, 0)
					SliderFrame.Size = UDim2.new(0, 381, 0, 70)
					...
					SliderText.Size = UDim2.new(0, 370, 0, 25)
					...
					Slider.Position = UDim2.new(0.0160000008, 0, 0.542999983, 0)
					Slider.Size = UDim2.new(0, 370, 0, 23)

					uyu.CornerRadius = UDim.new(0, 5)
					uyu.Parent = Slider
					...
					SliderButton.Size = UDim2.new(0, 370, 0, 23)
					...
					UICorner_16.Parent = InSliderFrame

					Num.Name = "Num"
					Num.Parent = InSliderFrame
					Num.Active = true
					Num.BackgroundColor3 = Color3.fromRGB(255, 70, 70)
					Num.BackgroundTransparency = 1.000
					Num.BorderColor3 = Color3.fromRGB(67, 67, 67)
					Num.Position = UDim2.new(0.930921078, 0, -1.65260839, 0)
					Num.Size = UDim2.new(0, 30, 0, 18)
					Num.Font = Enum.Font.GothamBold
					Num.Text = "1"
					Num.TextColor3 = Color3.fromRGB(255, 255, 255)
					Num.TextSize = 14.000
					Num.TextTransparency = 1.000

					Frame_2.Parent = Num
					Frame_2.BackgroundColor3 = Color3.fromRGB(255, 70, 70)
					Frame_2.BackgroundTransparency = 1.000
					Frame_2.BorderColor3 = Color3.fromRGB(255, 70, 70)
					Frame_2.Position = UDim2.new(0.100000001, 0, 1.16666663, 0)
					Frame_2.Rotation = 60.000
					Frame_2.Size = UDim2.new(0, 15, 0, 4)

					UICorner_18.CornerRadius = UDim.new(0, 5)
					UICorner_18.Parent = Frame_2

					Frame_3.Parent = Num
					Frame_3.BackgroundColor3 = Color3.fromRGB(255, 70, 70)
					Frame_3.BackgroundTransparency = 1.000
					Frame_3.BorderColor3 = Color3.fromRGB(255, 70, 70)
					Frame_3.Position = UDim2.new(0.385714293, 0, 1.16666663, 0)
					Frame_3.Rotation = -60.000
					Frame_3.Size = UDim2.new(0, 15, 0, 4)

					UICorner_19.CornerRadius = UDim.new(0, 5)
					UICorner_19.Parent = Frame_3

					Frame_4.Parent = Num
					Frame_4.BackgroundColor3 = Color3.fromRGB(255, 70, 70)
					Frame_4.BackgroundTransparency = 1.000
					Frame_4.BorderColor3 = Color3.fromRGB(255, 70, 70)
					Frame_4.Position = UDim2.new(0.385713696, 0, 1, 0)
					Frame_4.Size = UDim2.new(0, 7, 0, 7)

					UICorner_20.CornerRadius = UDim.new(0, 5)
					UICorner_20.Parent = Slider

					UICorner_17.CornerRadius = UDim.new(0, 5)
					UICorner_17.Parent = Num

					SliderButton.MouseEnter:Connect(
						function()
							TweenService:Create(Num, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundTransparency = 0}):Play(

							)
							TweenService:Create(Num, TweenInfo.new(.2, Enum.EasingStyle.Quad), {TextTransparency = 0}):Play()
							TweenService:Create(Frame_2, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundTransparency = 0}):Play(

							)
							TweenService:Create(Frame_3, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundTransparency = 0}):Play(

							)
							TweenService:Create(Frame_4, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundTransparency = 0}):Play(
					...
					SliderButton.MouseLeave:Connect(
						function()
							TweenService:Create(Num, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundTransparency = 1}):Play(

							)
							TweenService:Create(Num, TweenInfo.new(.2, Enum.EasingStyle.Quad), {TextTransparency = 1}):Play()
							TweenService:Create(Frame_2, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundTransparency = 1}):Play(

							)
							TweenService:Create(Frame_3, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundTransparency = 1}):Play(

							)
							TweenService:Create(Frame_4, TweenInfo.new(.2, Enum.EasingStyle.Quad), {BackgroundTransparency = 1}):Play(
					...
					SliderButton.MouseButton1Down:Connect(function()
						Value = math.floor((((tonumber(maxvalue) - tonumber(minvalue)) / 370) * InSliderFrame.AbsoluteSize.X) + tonumber(minvalue)) or 0
						pcall(function()
							callback(Value)
						end)
						InSliderFrame:TweenSize(UDim2.new(0, math.clamp(mouse.X - InSliderFrame.AbsolutePosition.X, 0, 370), 0, 23), "InOut", "Linear", 0.05, true)
						moveconnection = mouse.Move:Connect(function()
							Num.Text = Value
							Value = math.floor((((tonumber(maxvalue) - tonumber(minvalue)) / 370) * InSliderFrame.AbsoluteSize.X) + tonumber(minvalue))
							pcall(function()
								callback(Value)
							end)
				...
				function ContainerItems:Line()
					...
					Line.Position = UDim2.new(-0.0971128643, 0, 0.582010567, 0)
					Line.Size = UDim2.new(0, 381, 0, 7)
				...
				function ContainerItems:ColorPicker(text, preset, callback)
					...
					Colorpicker.Size = UDim2.new(0, 381, 0, 36)
					...
					Title.Size = UDim2.new(0, 381, 0, 36)
					Title.Text = text
					...
					ColorpickerFrame.Size = UDim2.new(0, 381, 0, 0)
					...
					Colorpicker.MouseButton1Click:Connect(
						function()
							if ColorPickerToggled == false then
								...
								repeat
									wait()
								until ColorpickerFrame.Size == UDim2.new(0, 381, 0, 100)
								Page.CanvasSize = UDim2.new(0, 0, 0, PageLayout.AbsoluteContentSize.Y)
							else
								ColorPickerToggled = not ColorPickerToggled
								ColorpickerFrame:TweenSize(
								...
								repeat
									wait()
								until ColorpickerFrame.Size == UDim2.new(0, 381, 0, 0)
								ColorpickerFrame.Visible = false
								Page.CanvasSize = UDim2.new(0, 0, 0, PageLayout.AbsoluteContentSize.Y)
							end
						end
				...
				function ContainerItems:KeyBind(keytext, first, callback)
					...
					KeyBindFrame.BackgroundColor3 = Color3.fromRGB(51, 51, 51)
					KeyBindFrame.BorderColor3 = Color3.fromRGB(51, 51, 51)
					KeyBindFrame.Position = UDim2.new(0.0196850393, 0, 0.637992859, 0)
					KeyBindFrame.Size = UDim2.new(0, 381, 0, 36)

					UICorner_21.CornerRadius = UDim.new(0, 5)
					UICorner_21.Parent = KeyBindFrame

					BindFrame.Name = "BindFrame"
					BindFrame.Parent = KeyBindFrame
					BindFrame.BackgroundColor3 = Color3.fromRGB(68, 68, 68)
					BindFrame.BorderColor3 = Color3.fromRGB(68, 68, 68)
					BindFrame.Position = UDim2.new(0.811475396, 0, 0.222222224, 0)
					BindFrame.Size = UDim2.new(0, 63, 0, 18)

					UICorner_22.CornerRadius = UDim.new(0, 5)
					UICorner_22.Parent = BindFrame

					BindButton.Name = "BindButton"
					BindButton.Parent = BindFrame
					BindButton.BackgroundColor3 = Color3.fromRGB(68, 68, 68)
					BindButton.BackgroundTransparency = 1.000
					BindButton.BorderColor3 = Color3.fromRGB(68, 68, 68)
					BindButton.Size = UDim2.new(0, 63, 0, 18)
					BindButton.Font = Enum.Font.GothamBold
					BindButton.Text = first
					BindButton.TextColor3 = Color3.fromRGB(188, 188, 188)
					BindButton.TextSize = 14.000
					BindButton.TextScaled = true

					UICorner_23.Parent = BindButton

					KeyBindText.Name = "KeyBindText"
					KeyBindText.Parent = KeyBindFrame
					KeyBindText.BackgroundColor3 = Color3.fromRGB(51, 51, 51)
					KeyBindText.BackgroundTransparency = 1.000
					KeyBindText.BorderColor3 = Color3.fromRGB(51, 51, 51)
					KeyBindText.Position = UDim2.new(0.0163934417, 0, 0, 0)
					KeyBindText.Size = UDim2.new(0, 200, 0, 36)
					KeyBindText.Font = Enum.Font.GothamBold
					KeyBindText.Text = keytext
					KeyBindText.TextColor3 = Color3.fromRGB(154, 154, 154)
					KeyBindText.TextSize = 14.000
					KeyBindText.TextXAlignment = Enum.TextXAlignment.Left

					UICorner_24.CornerRadius = UDim.new(0, 5)
					UICorner_24.Parent = KeyBindText

					BindButton.MouseButton1Down:Connect(
						function()
							ripple(BindButton, Mouse.X, Mouse.Y)
						end
					)
				...
				function ContainerItems:Toggle(TexT, callback)
					...
					ToggleFrame.Size = UDim2.new(0, 381, 0, 36)
					...
					Toggle.Size = UDim2.new(0, 384, 0, 36)
					...
					ToggleText.Size = UDim2.new(0, 200, 0, 36)
					...
					ToggleIconer.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
					ToggleIconer.BorderColor3 = Color3.fromRGB(40, 40, 40)
					...
					done.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
					done.BorderColor3 = Color3.fromRGB(40, 40, 40)
				...
				function ContainerItems:TextBox(TexT, Desc, callback)
					...
					TextBoxFrame.Position = UDim2.new(-0.00131233595, 0, 0.637992859, 0)
					TextBoxFrame.Size = UDim2.new(0, 381, 0, 36)

					UICorner_30.CornerRadius = UDim.new(0, 5)
					UICorner_30.Parent = TextBoxFrame
					...
					TextBox.Focused:Connect(function()
						TextBox:TweenSizeAndPosition(
							...
							UDim2.new(0.560, 0,0.166666672, 0),
							"Out","Quad",
							0.3,
							false
						)
					...
					TextBox.FocusLost:Connect(function()
						TextBox:TweenSizeAndPosition(
							...
							UDim2.new(0.667, 0, 0.166666672, 0),
							"Out","Quad",
							0.3,
							false
						)
				...
				function ContainerItems:Dropdown(teks, list, callback)
					...
					Dropdown.Size = UDim2.new(0, 381, 0, 36)
					...
					Arrow.Position = UDim2.new(0.913561523, 0, 0.111111104, 0)
					...
					DropdownFrame.Size = UDim2.new(0, 381, 0, 0)
					...
					DropdownHolder.Size = UDim2.new(0, 381, 0, 0)
						...
						function()
							if DropToggled == false then
								...
								repeat
									wait()
									Page.CanvasSize = UDim2.new(0, 0, 0, PageLayout.AbsoluteContentSize.Y)
								until DropdownFrame.Size == UDim2.new(0, 381, 0, FrameSize)
							else
								DropdownFrame:TweenSize(
									UDim2.new(0, 381, 0, 0),
									Enum.EasingDirection.Out,
								...
								repeat
									wait()
									Page.CanvasSize = UDim2.new(0, 0, 0, PageLayout.AbsoluteContentSize.Y)
								until DropdownFrame.Size == UDim2.new(0, 381, 0, 0)
							end
					...
					for i, v in next, list do
						...
						Item.Size = UDim2.new(0, 362, 0, 24)

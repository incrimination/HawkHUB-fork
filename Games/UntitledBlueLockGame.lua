...
local Window = Hawk:Window("Hawk HUB | Untitled Blue Lock Game")
local Tab1 = Window:Tab("Main")

Hawk:Bildirim("Loaded!","Welcome",2)
Tab1:Label("Main Stuff")
Tab1:Line()
Tab1:KeyBind("Get The Ball","L",function(messi)
	if game:GetService("Workspace"):FindFirstChild("Ball") then
		game:GetService("Workspace").Ball.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
	end
end)
Tab1:Button("Tp Tool",function(speed)
...
Tab1:Button("Speed",function(speed)
...
local CreditCardOnArkali = Window:Tab("Credits")
CreditCardOnArkali:Label("Made By Ediz")
